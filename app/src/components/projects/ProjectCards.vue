...
<template>
  ...
  <div v-show="isGroupedMode">
    ...
    <div v-for="(projects, groupName) in useGroupedProjects" :key="groupName" :class="{'content-paper': box,'rounded-3xl': box}">
  ...
  <div v-show="!isGroupedMode" :class="{'content-paper': box,'rounded-3xl': box}">
